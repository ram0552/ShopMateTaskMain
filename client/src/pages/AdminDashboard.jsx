...
//                                                 {isGeneratingDescription ? 'Generating...':'Genrate with ai'}
//                                             </button>
//                                             <textarea
//                                                 required
//                                                 rows={3}
...
//                                             className="text-blue-600 border border-blue-600 px-3 py-1 rounded-md text-sm hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed"
//                                                 >
